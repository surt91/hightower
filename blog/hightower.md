...
Das Paper ist auch als Zeitdokument lesenswert. Hightower hat sein Programm auf Platinen losgelassen, auf PERT-Diagramme und auf Labyrinthe, darunter eine rechtwinklige Fassung des Heckenlabyrinths von Hampton Court. Die Plots im Anhang stammen von einem *Dataplotter* der Electronics Associated Inc., und unter dem Hampton-Court-Bild steht „Total time .0005" (die Einheit steht nicht dabei, vermutlich Stunden, was zu den Abrechnungsgewohnheiten der Zeit passen würde). Dieses Labyrinth wollte ich exakt nachbauen. Der Scan des Papers liegt mit 300 dpi vor, die dünnen Linien sind die Wände, die dicke Linie ist Hightowers gefundener Pfad. Ein kurzes Python-Skript trennt die beiden nach Strichstärke, ordnet jedes Tintenpixel einem waagerechten oder senkrechten Strich zu, schließt die Lücken an den Kreuzungen und skaliert das Ergebnis auf ganze Zahlen (vier Pixel sind eine Einheit). Heraus kommen 54 Wandstücke in einem Feld von 392 × 372 Einheiten, dazu die Lage von A und B, abgelesen an den freien Enden der dicken Linie.

![Zwei Bilder. Links der Scan aus dem Paper: das Labyrinth in dünnen Linien, der gefundene Pfad dick, darüber in Schreibmaschinenschrift „Solution to Hampton Court Maze, Found Path From A To B, Total Time .0005". Rechts dieselben Wände, aus dem Scan nachgezeichnet, mit Hightowers Pfad grau unterlegt und dem Pfad dieser Implementierung in Rot, darüber dieselbe Beschriftung mit der neuen Zeit.](images/03_maze_comparison.png)

*Links Hightowers Plot von 1969 (Ausschnitt aus dem Paper), rechts das aus dem Scan nachgezeichnete Labyrinth. Grau sein Pfad, rot der Pfad dieser Implementierung. Die Zeit habe ich in seiner Einheit angegeben: rund 0,0000002 Stunden, also etwas über eine halbe Millisekunde, für 197 Linien in 39 Schritten.*

Dass die rote Linie nicht überall der grauen folgt, liegt nicht an der Rekonstruktion. Der Algorithmus hat an einigen Stellen Wahlfreiheit, etwa welches von zwei gleich weit entfernten Hindernisenden er zuerst probiert, und die Reihenfolge, in der die beiden Netze wachsen, hängt vom Startpunkt ab. Dass er das Labyrinth überhaupt löst, war weniger selbstverständlich, als ich dachte. Dazu weiter unten mehr.
...
Der erste ist harmlos, der Pfad ist nicht der kürzeste. Im Bild weiter oben war der gefundene Pfad 142 Einheiten lang statt 104, und im Labyrinth ist er mit 3410 Einheiten fast anderthalbmal so lang wie der kürzeste mit 2342. Für Diagramme ist das der gewünschte Kompromiss. Für Platinen schlug Hightower vor, den Algorithmus mehrfach mit leicht veränderten Regeln laufen zu lassen und den kürzesten der Kandidaten zu nehmen.
...
![Zwei Liniendiagramme mit logarithmischer Zeitachse. Links wächst die Kantenlänge des Spielfelds von 64 auf 2048 bei 20 Hindernissen: die Breitensuche steigt von rund 90 Mikrosekunden auf 68 Millisekunden, der Sichtbarkeitsgraph bleibt bei 16 bis 22 Mikrosekunden, Hightower bei ein bis zwei Mikrosekunden. Rechts wächst die Zahl der Rechtecke von 0 auf 320 bei fester Fläche: die Breitensuche bleibt bei einer halben bis einer Millisekunde, der Sichtbarkeitsgraph steigt von unter einer Mikrosekunde auf über eine halbe Millisekunde, Hightower von 0,4 auf etwa 17 Mikrosekunden.](images/12_benchmark.svg)

*Links: Die Fläche wächst, die Anzahl der Hindernisse bleibt. Rechts: Die Fläche bleibt, die Hindernisse werden mehr.*

Die linke Kurve ist der Grund für diesen Artikel. Bei 20 Rechtecken braucht Hightower ein bis zwei Mikrosekunden pro Route, und es ist ihm egal, ob das Spielfeld 64 oder 2048 Einheiten breit ist. Dem Sichtbarkeitsgraphen ist es ebenso egal, er liegt konstant bei etwa 16 bis 22 Mikrosekunden, also rund zehnmal über Hightower. Die Breitensuche skaliert mit der Fläche und landet bei 2048 Einheiten Kantenlänge bei 68 Millisekunden, was für einen interaktiven Editor mit vielen Kanten zu langsam wäre.

Rechts sieht man, was die beiden gitterfreien Verfahren kostet. Mit der Anzahl der Hindernisse wachsen die Kosten bei Hightower, weil jede Cover-Abfrage durch mehr Zeilen läuft und Prozess II mehr Linien probiert; beim Sichtbarkeitsgraphen wächst die Knotenzahl quadratisch, und A* muss entsprechend mehr davon anfassen. Bei 160 Rechtecken auf 256 × 256 Einheiten ist die Szene so voll, dass der Sichtbarkeitsgraph länger braucht als die Breitensuche, während Hightower bei 17 Mikrosekunden liegt. Ein Diagramm-Editor hätte in dieser Szene allerdings andere Sorgen. In der Spalte ganz rechts fällt außerdem auf, dass bei 160 Rechtecken 17 der Zufallsszenen von Hightower nicht gelöst wurden; die Messung zählt nur Szenen, die alle drei Router schaffen.
